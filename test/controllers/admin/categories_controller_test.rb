...
class Admin::CategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_category" do
    assert_difference('Admin::Category.count') do
      post admin_categories_url, params: { admin_category: { description: @admin_category.description, keywords: @admin_category.keywords, meta_desc: @admin_category.meta_desc, meta_title: @admin_category.meta_title, name: @admin_category.name, parent_id: @admin_category.parent_id, parmalink: @admin_category.parmalink, slug: @admin_category.slug } }
    end
  ...
  test "should update admin_category" do
    patch admin_category_url(@admin_category), params: { admin_category: { description: @admin_category.description, keywords: @admin_category.keywords, meta_desc: @admin_category.meta_desc, meta_title: @admin_category.meta_title, name: @admin_category.name, parent_id: @admin_category.parent_id, parmalink: @admin_category.parmalink, slug: @admin_category.slug } }
